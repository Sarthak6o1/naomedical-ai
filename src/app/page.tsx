        ...
        <AnimatePresence mode="wait">
          {!activeConvId && !roleSelected ? (
            <motion.div
              ...
              className="flex-1 flex flex-col items-center justify-center p-12 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-teal-950/20 via-black to-black"
            >
              ...
              <div className="flex gap-8 w-full max-w-5xl">
                ...
                >
                  <div className="h-full bg-slate-900/40 border border-white/5 p-12 rounded-[3.5rem] flex flex-col items-center gap-8 transition-all group-hover:bg-teal-600/10 group-hover:border-teal-500/30 group-hover:shadow-[0_0_80px_rgba(20,184,166,0.1)]">
                    <div className="w-24 h-24 bg-teal-600 rounded-[2.5rem] flex items-center justify-center shadow-2xl shadow-teal-900/40 group-hover:scale-110 transition-transform">
                      <Stethoscope size={40} className="text-white" />
                    </div>
                    <div className="text-center">
                ...
                >
                  <div className="h-full bg-slate-900/40 border border-white/5 p-12 rounded-[3.5rem] flex flex-col items-center gap-8 transition-all group-hover:bg-indigo-600/10 group-hover:border-indigo-500/30 group-hover:shadow-[0_0_80px_rgba(79,70,229,0.1)]">
                    <div className="w-24 h-24 bg-indigo-600 rounded-[2.5rem] flex items-center justify-center shadow-2xl shadow-indigo-900/40 group-hover:scale-110 transition-transform">
                      <UserCircle size={40} className="text-white" />
                    </div>
                    <div className="text-center">
                      <h3 className="text-2xl font-black text-white mb-2">Care Recipient</h3>
